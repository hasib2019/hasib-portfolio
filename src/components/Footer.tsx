      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-[#6b6b6b] text-sm italic">&quot;{personalInfo.tagline}&quot;</p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            {["#about", "#skills", "#experience", "#projects", "#education", "#contact"].map((href) => (
              <a
                key={href}
                href={href}
                className="text-[#6b6b6b] hover:text-white text-sm transition-colors duration-200 capitalize"
              >
                {href.replace("#", "")}
              </a>
            ))}
          ...
          <div className="flex gap-3">
            {[
              ...
              <a
                ...
                aria-label={s.label}
                className="w-8 h-8 flex items-center justify-center rounded-lg bg-[#1e1e1e] border border-[#2a2a2a] text-[#6b6b6b] hover:text-white hover:border-[#c0392b] transition-all duration-200"
              >
